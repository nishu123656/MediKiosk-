...
export default function HospitalLogin({ onSuccess, onRegister, onBack }: HospitalLoginProps) {
  const { login } = useAuth();

  const [identifier, setIdentifier] = useState("hospital@medikiosk.demo");
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    if (!identifier.trim() || !password.trim()) {
      setErrorMsg("Please enter both Hospital Facility ID / Email and password.");
      return;
    }
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 13, color: "#64748b" }}>New healthcare facility?</span>
          <button
            onClick={onRegister}
            style={{
              color: "#6d28d9",
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>
              Hospital roster, doctor approval, bed analytics and facility management
            </p>
          </div>
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 11, color: "#166534" }}>
              ...
              <span>
                <strong>Verified Facility:</strong> NABH Reg <strong>HOSP-MH-4012</strong>
              </span>
            </div>
          ...
          {forgotSent && (
            ...
            >
              Password recovery instructions have been dispatched to the hospital nodal admin email.
            </div>
          )}
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                placeholder="hospital@medikiosk.demo or HOSP-MH-4012"
                style={{
                  width: "100%",
                  padding: "10px 14px",
                  border: "1px solid #e8ecf0",
            ...
            <div style={{ marginBottom: 18 }}>
              ...
              <div style={{ position: "relative" }}>
                <input
                  ...
                  placeholder="Enter hospital administrative password"
                  style={{
                    width: "100%",
            ...
            >
              {loading ? "Authenticating Facility..." : "Sign In to Hospital Portal"}
            </button>
          </form>

          {/* Registration link */}
          <div style={{ marginTop: 24, textAlign: "center", borderTop: "1px solid #f1f5f9", paddingTop: 16 }}>
            <span style={{ fontSize: 12, color: "#64748b" }}>New hospital establishment? </span>
            <button
              onClick={onRegister}
              style={{
                background: "none",
