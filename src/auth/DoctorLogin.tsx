...
export default function DoctorLogin({ onSuccess, onRegister, onBack }: DoctorLoginProps) {
  const { login } = useAuth();

  const [identifier, setIdentifier] = useState("doctor@medikiosk.demo");
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    if (!identifier.trim() || !password.trim()) {
      setErrorMsg("Please enter both your Doctor ID / Email and password.");
      return;
    }
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 13, color: "#64748b" }}>New practitioner?</span>
          <button
            onClick={onRegister}
            style={{
              color: "#1d4ed8",
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: 24 }}>
            ...
            <p style={{ fontSize: 13, color: "#64748b", margin: 0 }}>
              OPD patient queue, clinical intelligence copilot and e-prescriptions
            </p>
          </div>

          {/* Practitioner Verification Status Card */}
          <div
            style={{
              padding: "10px 14px",
              background: "#f0fdf4",
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 11, color: "#166534" }}>
              ...
              <span>
                <strong>Verified Doctor:</strong> Reg. No. <strong>MCI-2018-38412</strong>
              </span>
            </div>
          ...
          {forgotSent && (
            ...
            >
              Password recovery instructions have been sent to your registered doctor email.
            </div>
          )}
          ...
          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: 16 }}>
              ...
              <input
                ...
                placeholder="doctor@medikiosk.demo or DOC-MH-38412"
                style={{
                  width: "100%",
                  padding: "10px 14px",
                  border: "1px solid #e8ecf0",
          ...
          <div style={{ marginTop: 24, textAlign: "center", borderTop: "1px solid #f1f5f9", paddingTop: 16 }}>
            <span style={{ fontSize: 12, color: "#64748b" }}>Not yet registered on MediKiosk? </span>
            <button
              onClick={onRegister}
              style={{
                background: "none",
